            ...
            .then(async (willDelete) => {
                ...
                if (willDelete) {
                    ...
                    if (!response.error) {
                        ...
                        newActivity(`Se ha eliminado el trabajo de periodo ${capitalizeFirstLetter(moment(item.from_contract).locale("es").format("MMMM"))}/${moment(item.from_contract).format("YYYY")} (idProv: ${idProv})`)
